                            ...
                            <header className="grow-0 h-18">
                                <nav className="bg-gray-900 text-white p-4">
                                    <div className="flex justify-between items-center">
                                        <div className={"italic text-base md:text-2xl"}>ToDo-plus+</div>
                                        <div className={"flex justify-center items-center gap-2 mr-4"}>
                                            <img
                                                className="inline-block w-5 h-5 md:w-10 md:h-10 rounded-md"
                                                ...
                                                alt="user" />
                                            <span className={"text-base md:text-2xl"}>{user && user.firstname}</span>
                                            <img title={"Signout"} className={"cursor-pointer w-6 h-6 md:w-10 md:h-10"}
